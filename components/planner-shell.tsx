  ...
  return (
    <main className="min-h-screen px-4 py-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-[1680px]">
        <div
          className="rounded-[32px] p-3 md:p-4"
          style={{
        ...
        >
          <div className="grid gap-4 xl:grid-cols-[280px_minmax(0,1.75fr)_320px]">
            <SummaryPanel
            ...
            <section className="surface rounded-[28px] p-5 md:p-6">
            ...
            <RightRail
              ...
              onStartPause={
                planner.pomodoro.isRunning ? planner.pausePomodoro : planner.startPomodoro
              }
